    ...
    <Container>
      ...
      <HomePageComp>
        ...
        <div className="body">
          ...
          <Title level={3}>한명 보다 나은 팀의 힘을 믿습니다.</Title>
          <p>
          ...
          <p>
            ...
            오로지 변화하는 생물 같은 시장에게 fast fail하며 깨닫고 배우며 배운
            것을 적용하고 pivot하는 것이 성공하는 자세이며 삶 전체를 관통하는
            법칙이라 믿습니다.
          </p>
          <Title level={1}>👦🏻 개발자로서 태도</Title>
          <ol>
            <li>
            ...
            <li>
              ...
              무엇인지 어떤 배경과 컨텍스트를 갖고있는지 명료하다면 회의 시간도
              단축되고 솔루션도 쉽게 나오기 때문입니다.
            </li>
            <li>
              refactoring & decoupling 을 자주 합니다. 재사용성 외에도 규모가
              커져도 유지보수가 용이하게끔 하며 각 단위 요소들이 의존성없이
              스스로의 무결성을 확보할 수 있기 때문입니다.
            </li>
            <li>
              다만 처음부터 코드를 분리하는데 시간을 쓰려고 하지 않습니다. 기능
              구현이 되는지를 먼저 체크하고 해당하는 기능의 재사용 가능성이
              예측이 된다면, 그 때 사용하기 좋게 묶을 방법을 고민해야 시간
              낭비가 줄기 때문입니다.
            </li>
            <li>
              이미 만들어 두었던 것의 개선 아이디어가 전혀 다른 일을 할 때
              떠오를 때가 있습니다. 여유가 된다면 떠오르는 즉시 적용하고 여유가
              없거나 너무 큰일이라면 리마인드 하기 위해 캘린더에 아이디어를
              간략히 적어놓습니다.
            </li>
            <li>
            ...
            <li>
              ...
              순간 잘 추가되지 않는 시점이 올 때 수많은 시간들을 단축시켜주기
              때문입니다.
            </li>
            <li>
              공부할 때는 가급적 찬찬히 깊게 글을 보려고 합니다. 깊게 보지 않고
              겉핥기로 넘어가면 분명 언젠가 몇번이고 그 내용을 다시 찾아보기
              때문입니다. 한번 깊게 몰입하고 파는 한시간이 수십번의 2분 보다
              낫다는 것을 매번 깨닫습니다.
            </li>
          </ol>
