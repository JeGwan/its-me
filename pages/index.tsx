          ...
          <HomePageComp>
            ...
            <div className="body">
              ...
              <p>
                ...
                것을 너무나 사랑하는 저는 오제관입니다. ❤️ 👨🏻‍💻
              </p>
              <Title level={1}>🤝 팀원으로서의 태도</Title>
              <Title level={3}>
                &quot;경쾌하게&quot; 누구를 만나든 어떤 일을 하든 먼저 경쾌한
                바이브로 임합니다.
              </Title>
              <p>
              ...
              <p>
                말을 장황하게 하거나 너무 지엽적이거나 추상적으로 표현하지
                않으려 합니다. 구체적이고 간결하며 명료하게 전달합니다.
              </p>
              ...
              <p>
                ...
                생각합니다. 예상되는 시장의 모습과 실제 모습은 높은 확률로
                다르며, 오로지 변화하는 생물 같은 시장에게 fast fail 하며 깨닫고
                배우며 배운 것을 적용하고 pivot 하는 것이 성공하는 자세이며 삶
                전체를 관통하는 법칙이라 믿습니다.
              </p>
              <Title level={1}>👦🏻 개발자로서의 태도</Title>
              <ol>
                <li>
                  개발이 허들이 되지 않게 합니다. 안 해본 것 안 가본 길을
                  피하려고 기능을 타협하지 않으려 합니다. 제가 편하기보다
                  기획자의 의도를 그대로 반영하고 유저의 편의성을 위해 노력할 때
                  좋은 제품이 나오기 때문입니다.
                </li>
                <li>
                  어떠한 feature를 추가할 때 수행해야 할 to do list를 더는 쪼갤
                  수 없을 정도로 잘게 쪼개서 글로 써봅니다. 그 뒤 step by
                  step으로 pseudo 코드를 작성해놓고 작업합니다. 이렇게 하면
                  커다랗고 다소 손에 잡히지 않던 기능도 unit task들이 되어
                  하나하나 수월히 작업할 수 있습니다. 또한 작업에 빠지다 보면
                  어떤 지엽적인 막힘 때문에 본질을 잊게 되기도 하는데 이렇게
                  프레임을 잡아놓는다면 큰 그림을 지키고 헤매지 않게 되기
                  때문입니다.
                </li>
                <li>
                  이왕이면 기능의 무결성, performance 외에도 코드가 팀원들에게
                  직관적으로 인식될 수 있는지, 유저에게 충분한 affordance를
                  주는지 interaction과 animation이 매끄럽고 어울리는지. 다각도로
                  퀄리티를 체크하고 배포합니다.
                </li>
                <li>
                  가독성과 유지보수를 위해 변수명이 길어져도 할당되는 값을
                  충분히 나타내게 씁니다.
                </li>
                <li>
                  이슈가 있을 땐 가장 먼저 problem definition을 합니다. 문제가
                  무엇인지 어떤 배경과 context를 갖고있는지 명료하다면 회의
                  시간도 단축되고 솔루션도 쉽게 나오기 때문입니다.
                </li>
                <li>
                ...
                <li>
                  다만 처음부터 코드를 분리하는 데 시간을 쓰려고 하지 않습니다.
                  기능 구현이 되는지를 먼저 체크하고 해당하는 기능의 재사용
                  가능성이 예측된다면, 그때 사용하기 좋게 묶을 방법을 고민해야
                  시간 낭비가 줄기 때문입니다.
                </li>
                <li>
                  이미 만들어 두었던 것의 개선 아이디어가 전혀 다른 일을 할 때
                  떠오를 때가 있습니다. 여유가 된다면 떠오르는 즉시 적용하고
                  여유가 없거나 너무 큰 일이라면 리마인드 하기 위해 캘린더에
                  아이디어를 간략히 적어놓습니다.
                </li>
                <li>
                  지금 작업하거나 설정한 일이 빈도가 아주 낮은데 나중에 다시 볼
                  때 잘 기억이 안 날 거 같거나 헤맬 것 같다면 화면녹화로 나를
                  위한 설명을 찍어 놓거나 어딘가에 글로 정리합니다. 기억은
                  garbage collector가 있지만, 기록은 immutable이기 때문입니다.
                </li>
                <li>
                  생산성 향상을 위해 shortcut을 숙지하고 code snippet, custom
                  shortcut 등을 필요할 때마다 만들어 놓습니다. 처음엔 귀찮지만,
                  어느 순간 잘 추가되지 않는 시점이 올 때 수많은 시간을
                  단축해주기 때문입니다.
                </li>
                <li>
                  공부할 때는 가급적 찬찬히 깊게 글을 보려고 합니다. 깊게 보지
                  않고 겉핥기로 넘어가면 분명 언젠가 몇 번이고 그 내용을 다시
                  찾아보기 때문입니다. 한번 깊게 몰입하고 파는 한 시간이
                  수십번의 2분보다 낫다는 것을 매번 깨닫습니다.
                </li>
              </ol>
              ...
              <p>
                Front-end : Next.js를 기본 프레임워크로 씁니다. 스타일
                라이브러리로 styled-component를 씁니다.
              </p>
              <p>
